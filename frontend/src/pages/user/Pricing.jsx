                ...
                <div className="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-y-8 sm:mt-10 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:gap-x-8 xl:gap-x-12">
                    ...
                    <div className={`relative rounded-3xl p-8 ring-1 ring-violet-600 bg-white dark:bg-zinc-900 shadow-2xl ${isPro ? 'ring-2 ring-emerald-500' : ''}`}>
                        ...
                        {isPro ? (
                            ...
                            <Link to="/checkout" className="mt-8 block rounded-md bg-violet-600 py-2 px-3 text-center text-sm font-semibold leading-6 text-white shadow-sm hover:bg-violet-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-600 transition-all">
                                Upgrade to Pro
                            </Link>
                        )}
                    </div>
